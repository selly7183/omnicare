  ...
  e.fn.fullpage = function (V) {
    if (e("html").hasClass(d)) kt();
      ...
      kt(),
        ...
        e(this).length &&
          ...
          ($.setAutoScrolling = Ze),
          ($.setRecordHistory = Ne),
          ($.setScrollingSpeed = je),
          ($.setFitToSection = qe),
          ($.setLockAnchors = function (e) {
            V.lockAnchors = e;
          }),
          ($.setMouseWheelScrolling = Ge),
          ($.setAllowScrolling = Ue),
          ($.setKeyboardScrolling = Qe),
          ($.moveSectionUp = Je),
          ($.moveSectionDown = Ke),
          ($.silentMoveTo = _e),
          ($.moveTo = $e),
          ...
          ($.destroy = function (n) {
            le.trigger("destroy", [n]),
              ...
              clearTimeout(Se),
              clearTimeout(we),
              J.off("scroll", cn).off("hashchange", Dn).off("resize", _n),
              K.off("keydown", Yn)
                .off("keyup", Wn)
              ...
              e(m).off("click touchstart", Z),
              yt("dragAndMove") && $.dragAndMove.destroy();
            clearTimeout(me),
              clearTimeout(ge),
              n &&
                (function () {
          ...
          ($.landscapeScroll = Un),
          ($.shared = { afterRenderActions: sn }),
          an("continuousHorizontal"),
          an("scrollHorizontally"),
          an("resetSliders"),
          ...
          an("parallax"),
          yt("dragAndMove") && $.dragAndMove.init(),
          (function () {
            V.css3 &&
              (V.css3 = (function () {
                var e,
                ...
                for (var r in (t.body.insertBefore(o, null), a))
                  o.style[r] !== i &&
                    ((o.style[r] = "translate3d(1px,1px,1px)"),
                    (e = n.getComputedStyle(o).getPropertyValue(a[r])));
                return (
                  t.body.removeChild(o), e !== i && e.length > 0 && "none" !== e
                );
              })());
            (V.scrollBar = V.scrollBar || V.hybrid),
              (o = le.find(V.sectionSelector)),
              V.anchors.length ||
                (V.anchors = o
                  .filter("[data-anchor]")
                  .map(function () {
              ...
              (se = J.height()),
              le.removeClass(c),
              le.find(V.sectionSelector).addClass(g),
              le.find(V.slideSelector).addClass(z),
              Ct("parallax", "init"),
              e(m).each(function (n) {
                var t,
                  o,
                  ...
                  s = l.find(I),
                  c = s.length;
                l.data("fp-styles", l.attr("style")),
                  (i = l),
                  (a = n) || 0 !== e(S).length || i.addClass(u),
                  (oe = e(S)),
                  i.css("height", ln(i) + "px"),
                  V.paddingTop && i.css("padding-top", V.paddingTop),
                  V.paddingBottom && i.css("padding-bottom", V.paddingBottom),
                  void 0 !== V.sectionsColor[a] &&
                    i.css("background-color", V.sectionsColor[a]),
                  void 0 !== V.anchors[a] &&
                    i.attr("data-anchor", V.anchors[a]),
                  (t = l),
                  (o = n),
                  void 0 !== V.anchors[o] &&
                    t.hasClass(u) &&
                  ...
                  V.menu &&
                    ...
                    e(V.menu).appendTo(_),
                  c > 0 ? rn(l, s, c) : V.verticalCentered && at(l);
              }),
              V.fixedElements && V.css3 && e(V.fixedElements).appendTo(_),
              V.navigation &&
                (function () {
                  ...
                  e(M).css("margin-top", "-" + e(M).height() / 2 + "px"),
                    e(M).find("li").eq(e(S).index(m)).find("a").addClass(u);
                })(),
              le.find('iframe[src*="youtube.com/embed/"]').each(function () {
                ...
                (n = e(this)),
                  (t = "enablejsapi=1"),
                  (o = n.attr("src")),
                  n.attr("src", o + (/\?/.test(o) ? "&" : "?") + t);
              }),
              V.fadingEffect && $.fadingEffect && $.fadingEffect.apply(),
              V.scrollOverflow ? (he = V.scrollOverflowHandler.init(V)) : sn(),
              Ue(!0),
              Ze(V.autoScrolling, "internal"),
              $n(),
              ht(),
              "complete" === t.readyState && Bn();
            var o;
            J.on("load", Bn);
          })(),
          J.on("scroll", cn).on("hashchange", Dn).blur(Nn).resize(_n),
          K.keydown(Yn)
            .keyup(Wn)
            .on("click touchstart", M + " a", jn)
            .on("click touchstart", X, qn)
            .on("click", O, Fn),
          e(m).on("click touchstart", Z, Zn),
          V.normalScrollElements &&
            (K.on("mouseenter touchstart", V.normalScrollElements, function () {
              Ue(!1);
            }),
    ...
    function Ze(n, t) {
      ...
      V.autoScrolling && !V.scrollBar
        ? (G.css({ overflow: "hidden", height: "100%" }),
          Ne(Me.recordHistory, "internal"),
          le.css({ "-ms-touch-action": "none", "touch-action": "none" }),
          o.length && St(o.position().top))
        : (G.css({ overflow: "visible", height: "initial" }),
          Ne(!1, "internal"),
          le.css({ "-ms-touch-action": "", "touch-action": "" }),
          xt(le),
          o.length && G.scrollTop(o.position().top)),
        le.trigger("setAutoScrolling", [n]);
    }
    function Ne(e, n) {
        ...
        ? (!(function () {
            ...
            var a =
              "onwheel" in t.createElement("div")
                ...
                : "DOMMouseScroll";
            "DOMMouseScroll" == a
              ? t[e](o + "MozMousePixelScroll", Sn, !1)
              : t[e](o + a, Sn, !1);
          })(),
          le.on("mousedown", Xn).on("mouseup", Vn))
        : (t.addEventListener
            ? (t.removeEventListener("mousewheel", Sn, !1),
              t.removeEventListener("wheel", Sn, !1),
              t.removeEventListener("MozMousePixelScroll", Sn, !1))
            : t.detachEvent("onmousewheel", Sn),
          le.off("mousedown", Xn).off("mouseup", Vn));
    }
    function Ue(n, t) {
      void 0 !== t
        ? ((t = t.replace(/ /g, "").split(",")),
        ...
        : (bt(n, "all", "m"),
          n
            ? (Ge(!0),
              (ae || re) &&
                (V.autoScrolling && _.off(Ce.touchmove).on(Ce.touchmove, vn),
                e(r)
                  .off(Ce.touchstart)
                  .on(Ce.touchstart, gn)
                  .off(Ce.touchmove)
            ...
            : (Ge(!1),
              (ae || re) &&
                (V.autoScrolling && _.off(Ce.touchmove),
                e(r).off(Ce.touchstart).off(Ce.touchmove))));
    }
    function Qe(n, t) {
      void 0 !== t
        ? ((t = t.replace(/ /g, "").split(",")),
        ...
        (ce = !0),
          ...
          e(m).each(function () {
            ...
            V.verticalCentered &&
              ...
              t.length > 1 && Un(n, n.find(L));
          }),
          V.scrollOverflow && he.createScrollBarForAll();
        var t = e(S).index(m);
        t && !yt("fadingEffect") && _e(t + 1),
          (ce = !1),
          e.isFunction(V.afterResize) && n && V.afterResize.call(le),
          e.isFunction(V.afterReBuild) && !n && V.afterReBuild.call(le),
          le.trigger("afterRebuild");
      }
    }
    function on(n) {
      var t = _.hasClass(l);
      n
        ? t ||
          ...
          e(M).hide(),
          _.addClass(l),
          e.isFunction(V.afterResponsive) && V.afterResponsive.call(le, n),
          V.responsiveSlides &&
            $.responsiveSlides &&
            $.responsiveSlides.toSections(),
          le.trigger("afterResponsive", [n]))
        : t &&
          (Ze(Me.autoScrolling, "internal"),
          qe(Me.autoScrolling, "internal"),
          e(M).show(),
          _.removeClass(l),
          e.isFunction(V.afterResponsive) && V.afterResponsive.call(le, n),
          V.responsiveSlides &&
    ...
    function rn(n, t, o) {
          ...
          (V.controlArrows &&
            (function (e) {
              e
                .find(E)
                .after(
                  '<div class="' + j + '"></div><div class="' + U + '"></div>'
                ),
      ...
      var r = n.find(L);
      r.length &&
      (0 !== e(S).index(m) || (0 === e(S).index(m) && 0 !== r.index()))
        ? (mt(r, "internal"), r.addClass(Y))
        : t.eq(0).addClass(u);
    }
    function ln(e) {
      return V.offsetSections && $.offsetSections
        ? o.round($.offsetSections.getWindowHeight(e))
        : se;
    }
    function sn() {
      var n,
      ...
      t.addClass(h),
        ...
        (!(n = st(Pn().section)) || (n.length && n.index() === oe.index())) &&
          e.isFunction(V.afterLoad) &&
          V.afterLoad.call(t, t.data("anchor"), t.index(m) + 1),
        e.isFunction(V.afterRender) && V.afterRender.call(le),
        le.trigger("afterRender");
    }
    function cn() {
    ...
    function dn() {
      ...
      if (
        (le.trigger("onScroll"),
        (!V.autoScrolling || V.scrollBar || yt("dragAndMove")) && !At())
      ) {
        var r = yt("dragAndMove")
            ? o.abs($.dragAndMove.getCurrentScroll())
            : J.scrollTop(),
          l = ((a = (i = r) > ze ? "down" : "up"), (ze = i), (We = i), 0),
          s = r + J.height() / 2,
          c =
            (yt("dragAndMove")
              ? $.dragAndMove.getDocumentHeight()
              : _.height() - J.height()) === r,
        ...
        if (!(n = e(d).eq(l)).hasClass(u)) {
          ...
          var v,
            ...
            x = n.index(m) + 1,
            y = n.find(L);
          y.length && ((h = y.data("anchor")), (v = y.index())),
            fe &&
              (n.addClass(u).siblings().removeClass(u),
              Ct("parallax", "afterLoad"),
              e.isFunction(V.onLeave) && V.onLeave.call(p, g, x, w),
              e.isFunction(V.afterLoad) && V.afterLoad.call(n, b, x),
              V.resetSliders &&
                $.resetSliders &&
                $.resetSliders.apply({
                  localIsResizing: ce,
    ...
    function hn(n) {
      ...
      if (pn(t)) {
        ...
        (He = a.y),
          (Ee = a.x),
          i.find(E).length && o.abs(Le - Ee) > o.abs(Ie - He)
            ? !ie &&
              o.abs(Le - Ee) > (J.outerWidth() / 100) * V.touchSensitivity &&
              (Le > Ee ? ve.m.right && en(i) : ve.m.left && nn(i))
            : V.autoScrolling &&
              fe &&
              o.abs(Ie - He) > (J.height() / 100) * V.touchSensitivity &&
              (Ie > He ? un("down") : He > Ie && un("up"));
      }
    }
    function pn(e) {
      ...
      if (V.autoScrolling && !te && !a) {
        var r = (t = t || n.event).wheelDelta || -t.deltaY || -t.detail,
          ...
          c =
            ...
            !s;
        ue.length > 149 && ue.shift(),
          ue.push(o.abs(r)),
          V.scrollBar &&
            (t.preventDefault ? t.preventDefault() : (t.returnValue = !1));
        var d = i - Ye;
        if (((Ye = i), d > 200 && (ue = []), fe && !Tt()))
          mn(ue, 10) >= mn(ue, 70) && c && un(l < 0 ? "down" : "up");
        return !1;
      }
    ...
    function xn(e) {
      var n = e.position(),
        t = n.top,
        o =
          yt("dragAndMove") && $.dragAndMove.isGrabbing
            ? $.dragAndMove.isScrollingDown()
            : n.top > We,
      ...
      return (
        e.outerHeight() > se
          ? ((o || a) && "bottom" !== a) || (t = i)
          : (o || (ce && e.is(":last-child"))) && (t = i),
        V.offsetSections &&
          $.offsetSections &&
          (t = $.offsetSections.getSectionPosition(o, t, e)),
        (We = t),
        t
      );
    }
    function yn(n, t, i) {
      if (void 0 !== n && n.length) {
        ...
        if (
          !(
            (s.activeSection.is(n) && !ce) ||
            (V.scrollBar && J.scrollTop() === s.dtop && !n.hasClass(C))
          )
        ) {
          if (
            (s.activeSlide.length &&
              ((a = s.activeSlide.data("anchor")), (l = s.activeSlide.index())),
            e.isFunction(V.onLeave) && !s.localIsResizing)
          ) {
            var c = s.yMovement;
            if (
              (void 0 !== i && (c = i ? "up" : "down"),
              !1 ===
                V.onLeave.call(
                  s.activeSection,
                  s.leavingSection,
          ...
          Ct("parallax", "apply", s),
            V.autoScrolling &&
              ...
              (s = (function (n) {
                n.isMovementUp
                  ? n.activeSection.before(n.activeSection.nextAll(m))
                  : n.activeSection.after(
                      n.activeSection.prevAll(m).get().reverse()
                    );
                return (
                  St(e(S).position().top),
                  bn(),
                  ...
                  (n.yMovement = ot(n.element)),
                  (n.leavingSection = n.activeSection.index(m) + 1),
                  (n.sectionIndex = n.element.index(m)),
                  e(r).trigger("onContinuousVertical", [n]),
                  n
                );
              })(s)),
            yt("scrollOverflowReset") &&
              $.scrollOverflowReset.setPrevious(s.activeSection),
            ...
            (fe = !1),
            ft(l, a, s.anchorLink, s.sectionIndex),
            (function (n) {
              if (V.css3 && V.autoScrolling && !V.scrollBar) {
                ...
                e(i.element)
                  .animate(i.options, V.scrollingSpeed, V.easing)
                  .promise()
                  .done(function () {
                    V.scrollBar
                      ? setTimeout(function () {
            ...
            tt(
              s.anchorLink,
              (function (n) {
                if (n.wrapAroundElements && n.wrapAroundElements.length)
                  return n.isMovementUp ? e(m).length - 1 : 0;
    ...
    function Cn(n) {
      ...
      (t = n).wrapAroundElements &&
        ...
        V.scrollOverflow && V.scrollOverflowHandler.afterLoad(),
        Ct("parallax", "afterLoad"),
        yt("scrollOverflowReset") && $.scrollOverflowReset.reset(),
        V.resetSliders && $.resetSliders && $.resetSliders.apply(n),
        n.localIsResizing || Mn(n.element),
        n.element.addClass(h).siblings().removeClass(h),
        (fe = !0),
    ...
    function zn(e) {
      ...
      function t(e) {
        ...
        for (e = e.replace(/[^A-Za-z0-9+/=]/g, ""); c < e.length; )
          (t =
            (n.indexOf(e.charAt(c++)) << 2) |
            ((a = n.indexOf(e.charAt(c++))) >> 4)),
            (o = ((15 & a) << 4) | ((r = n.indexOf(e.charAt(c++))) >> 2)),
            (i = ((3 & r) << 6) | (l = n.indexOf(e.charAt(c++)))),
      ...
      return (function (e) {
        ...
        if (n.length > 1) {
          var i = n[1];
          return (
            e.replace(o(n[1]), "").split("_")[0] +
            "_" +
            t(i.slice(3).slice(0, -3))
          );
        }
        return o(e);
      })(t(e));
    ...
    function In(e) {
      ...
      var d = c ? zn(ke[e]) : "",
        f =
          (d = d.split("_")).length > 1 &&
          d[1].indexOf(e, d[1].length - e.length) > -1;
      return (
        (!(d[0].indexOf(n, d[0].length - n.length) < 0 && s && l != d[0]) &&
          f) ||
        !s
      );
    }
    function Ln(n) {
      (Be = zn(
        ...
        (De = e("<div/>").html(Be).contents()),
        yt(n) && $[n] && (In(n) || (Hn(), setInterval(Hn, 2e3)));
    }
    function Hn() {
      Te ||
        (o.random() < 0.5 ? _.prepend(De) : _.append(De),
        (Te = !0),
        De.bind("destroyed", function () {
    ...
    function Gn(e) {
      fe &&
        (e.pageY < Xe && ve.m.up ? Je() : e.pageY > Xe && ve.m.down && Ke()),
        (Xe = e.pageY);
    }
    function Un(n, t, o) {
      var i = n.closest(m),
      ...
      (a.xMovement = it(a.prevSlideIndex, a.slideIndex)),
        a.localIsResizing || (fe = !1),
        Ct("parallax", "applyHorizontal", a),
        V.onSlideLeave &&
        !a.localIsResizing &&
        "none" !== a.xMovement &&
        ...
        !1 ===
          ...
          : (t.addClass(u).siblings().removeClass(u),
            a.localIsResizing || (On(a.prevSlide), An(t)),
            Qn(a),
            i.hasClass(u) &&
              !a.localIsResizing &&
              ft(a.slideIndex, a.slideAnchor, a.anchorLink, a.sectionIndex),
            $.continuousHorizontal && $.continuousHorizontal.apply(a),
            At() ? Jn(a) : Kn(n, a, !0),
            V.interlockedSlides &&
              $.interlockedSlides &&
              ((yt("continuousHorizontal") &&
                void 0 !== o &&
                o !== a.xMovement) ||
                $.interlockedSlides.apply(a)));
    }
    function Qn(e) {
      !V.loopHorizontal &&
        V.controlArrows &&
        (e.section.find(q).toggle(0 !== e.slideIndex),
        e.section.find(Q).toggle(!e.destiny.is(":last-child")));
    }
    function Jn(n) {
      var t, o;
      $.continuousHorizontal && $.continuousHorizontal.afterSlideLoads(n),
        (t = n.slidesNav),
        (o = n.slideIndex),
        t.find(v).removeClass(u),
        t.find("li").eq(o).find("a").addClass(u),
        n.localIsResizing ||
          (Ct("parallax", "afterSlideLoads"),
          ...
          Mn(n.destiny)),
        (ie = !1),
        yt("interlockedSlides") && $.interlockedSlides.apply(n);
    }
    function Kn(e, n, t) {
      var i = n.destinyPos;
      if (V.css3) {
        var a = "translate3d(-" + o.round(i.left) + "px, 0px, 0px)";
        et(e.find(D)).css(wt(a)),
          (me = setTimeout(
            function () {
              t && Jn(n);
            },
    ...
    function ct(e, n) {
      ...
      if (t.length) {
        var o,
          ...
          r =
            ((o = n),
            (a = (i = t).find(I + '[data-anchor="' + o + '"]')).length ||
              ((o = void 0 !== o ? o : 0), (a = i.find(I).eq(o))),
            a);
        e === ee || t.hasClass(u)
          ? dt(r)
          : yn(t, function () {
    ...
    function mt(e, n) {
      je(0, "internal"),
        ...
        Un(e.closest(E), e),
        void 0 !== n && (ce = !1),
        je(Me.scrollingSpeed, "internal");
    }
    function St(e) {
      var n = o.round(e);
      V.css3 && V.autoScrolling && !V.scrollBar
        ? lt("translate3d(0px, -" + n + "px, 0px)", !1)
        : V.autoScrolling && !V.scrollBar
        ? le.css("top", -n)
        : G.scrollTop(n);
    }
    ...
    function bt(n, t, o) {
      "all" !== t
        ? (ve[o][t] = n)
        : e.each(Object.keys(ve[o]), function (e, t) {
            ve[o][t] = n;
          });
    }
    function xt(e) {
    ...
    function yt(e) {
      return null !== V[e] && "object" == typeof V[e]
        ? V[e].enabled && $[e]
        : V[e] && $[e];
    }
    function Ct(e, n, t) {
